...
void vid_draw_line(lcd_info *p,int horiz_start, int vert_start, int horiz_end, int vert_end, int width, int color, alt_video_display* display);
...
void vid_round_corner_points( int cx, int cy, int x, int y, 
                              int straight_width, int straight_height, int color, lcd_info *p,
...
int vid_print_char_alpha (lcd_info *p,int horiz_offset,
                          int vert_offset,
                          int color,
                          char character,
...
int vid_print_string_alpha(lcd_info *p, int horiz_offset,
                            int vert_offset,
                            int color,
                            int background_color,
                            struct abc_font_struct font[],
