...
#ifdef ALT_ENHANCED_INTERRUPT_API_PRESENT
  if ((alt_ic_isr_register(TOUCH_PEN_IRQ_N_IRQ_INTERRUPT_CONTROLLER_ID,
		                   p->penirq_irq,
		                   touch_isr,
		                   (void *)p,
		                   NULL
...
#ifdef ALT_ENHANCED_INTERRUPT_API_PRESENT
    alt_ic_irq_disable(TOUCH_PEN_IRQ_N_IRQ_INTERRUPT_CONTROLLER_ID,TOUCH_PEN_IRQ_N_IRQ);
#else
    alt_irq_disable(id);
#endif
...
#ifdef ALT_ENHANCED_INTERRUPT_API_PRESENT
    alt_ic_irq_enable(TOUCH_PEN_IRQ_N_IRQ_INTERRUPT_CONTROLLER_ID,TOUCH_PEN_IRQ_N_IRQ);
#else
    alt_irq_enable(id);
#endif
